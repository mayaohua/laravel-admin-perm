...
<el-main>
    ...
    <el-form label-position="top" label-width="80px" :model="formdata" :rules="rules" ref="formdata">
        ...
        <el-form-item label="角色权限" prop="perms" :error="errormsg.permissions">
            <el-tree :data="perms" show-checkbox default-expand-all node-key="id" ref="tree" highlight-current :props="defaultProps">
            </el-tree>
        </el-form-item>
            ...
            submitForm: function(formName) {
                ...
                this.$refs[formName].validate(function(valid) {
                    if (valid) {
                        ...
                        vm.errormsg = {};
                        setTimeout(function() {
                            axios.post("{{route('admin.role.store')}}", vm.formdata).then(function(reason) {

...
<el-main>
    ...
    <el-table :data="tableData" stripe max-height="800" tooltip-effect="dark" @selection-change="handleSelectionChange" style="width: 100%">
        <el-table-column type="selection" width="55">
        </el-table-column>
        <el-table-column prop="show_name" label="角色名称">
        </el-table-column>
        <el-table-column prop="name" label="角色操作名称">
        </el-table-column>
        <el-table-column prop="guard_name" label="角色分组">
        </el-table-column>
    ...
    <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="pageSizes" :page-size="pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total" style="margin-top:20px;">
    </el-pagination>
    ...
    new Vue({
        ...
        methods: {
            handleClick: function(row) {
                window.location.href = "/{{config('webset.web_indexname')}}/role/" + row.id + "/edit";
            },

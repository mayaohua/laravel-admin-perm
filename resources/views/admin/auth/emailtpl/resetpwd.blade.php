...
<body>
    ...
    <div style="background:#fff;border:1px solid #ccc;margin:2%;padding:0 30px;">
        ...
        <p style="margin:0;padding:0;line-height:30px;font-size:14px;color:#333;font-family:'宋体',arial,sans-serif">您好！您正在进行修改密码邮箱身份验证，本次请求的验证码为：</p>
